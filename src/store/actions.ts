...
export default <ActionTree<State, State>>{
    ...
    [ABILITY_DECREMENT]({ commit, getters, state }: ActionContext<State, State>,
        { mercName, abilityName }: { mercName: string, abilityName: string }): void {
    ...
    [ITEM_INCREMENT]({ commit, getters, state }: ActionContext<State, State>,
    ...
    [ITEM_DECREMENT]({ commit, getters, state }: ActionContext<State, State>,
        { mercName, itemName }: { mercName: string, itemName: string }): void {
